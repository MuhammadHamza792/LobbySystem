...
namespace UI.States
{
    public class LoginState : MonoBehaviour, IPanelState , INotifier
    {
        ...
        {
            NotificationHelper.SendNotification(NotificationType.Progress, "Failed To Initialize",
                this, NotifyCallType.Close);
        ...
        {
            NotificationHelper.SendNotification(NotificationType.Progress, "Failed To SignIn",
                this, NotifyCallType.Close);
            NotificationHelper.SendNotification(NotificationType.Error, msg, this, NotifyCallType.Open);
        }
